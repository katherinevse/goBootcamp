...
func main() {
	ch := make(chan string, 5) // Создадим канал вместимостью 5 элементов стрингов
	//Эта строка кода добавляет строку "Bob" в канал ch
	...
	fmt.Println(<-ch) // Выводит 1 элемент, который был туда помещен
	fmt.Println(<-ch)
}
